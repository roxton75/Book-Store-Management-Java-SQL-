...
class CustomComboBoxUI extends BasicComboBoxUI {
    ...
    protected JButton createArrowButton() {
        ...
        arrowButton.setFont(new Font("Netflix Sans", Font.BOLD, 22));
        arrowButton.setForeground(new Color(236, 223, 204));
        arrowButton.setBackground(new Color(105, 117, 101)); // Yellow arrow button
